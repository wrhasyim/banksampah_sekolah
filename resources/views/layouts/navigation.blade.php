            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('setoran.index')" :active="request()->routeIs('setoran.*')">{{ __('Setoran Sampah') }}</x-nav-link>
                        <x-nav-link :href="route('penarikan.index')" :active="request()->routeIs('penarikan.*')">{{ __('Penarikan Saldo') }}</x-nav-link>
                        ...
                        <x-nav-link :href="route('kas-kecil.index')" :active="request()->routeIs('kas-kecil.*')">{{ __('Kas Kecil') }}</x-nav-link>
                    @endif
                </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        @if(Auth::user()->role === 'admin')
    <x-dropdown-link :href="route('settings.index')">{{ __('Pengaturan Website') }}</x-dropdown-link>
    @endif
