                        ...
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 1.1.9 2 2 2h12a2 2 0 002-2V7M4 7a2 2 0 012-2h4M16 5a2 2 0 012 2m-4 0a2 2 0 00-2 2v2m4-4h4a2 2 0 012 2v10a2 2 0 01-2 2h-4"></path></svg>
                                    <div>Master Data</div>
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('pengguna.index')">Data Pengguna</x-dropdown-link>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('insentif.pembayaran')">Pembayaran Insentif</x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>

                    <x-nav-link :href="route('buku-kas.index')" :active="request()->routeIs('buku-kas.index')">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                        {{ __('Buku Kas') }}
                    </x-nav-link>
<x-nav-link :href="route('rekapan.menyeluruh')" :active="request()->routeIs('rekapan.menyeluruh')">
    {{ __('Rekap Menyeluruh') }}
</x-nav-link>
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('rekapan.siswa.terlambat')">
                                    {{ __('Rekapan Siswa Terlambat') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('rekapan.siswa.tanpaWaliKelas')">
                                    {{ __('Rekapan Tanpa Wali Kelas') }}
                                </x-dropdown-link>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <a href="{{ route('nota.index') }}" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <x-nav-link :href="route('leaderboard.index')" :active="request()->routeIs('leaderboard.index')">
                         <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7.014A8.003 8.003 0 0112 3c1.398 0 2.743.54 3.728 1.486l-3.728 3.728m0 0l3.728 3.728-3.728-3.728z"></path></svg>
                        {{ __('Leaderboard') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        {{-- Konten navigasi mobile bisa ditambahkan di sini jika diperlukan --}}
    </div>
</nav>