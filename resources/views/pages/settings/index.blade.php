                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <input id="site_favicon" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none" type="file" name="site_favicon">
                            <p class="mt-1 text-sm text-gray-500">Gunakan file .ico, .png, atau .jpg.</p>
