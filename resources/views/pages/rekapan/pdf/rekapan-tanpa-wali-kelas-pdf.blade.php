{{-- File: resources/views/pages/rekapan/pdf/rekapan-tanpa-wali-kelas-pdf.blade.php --}}
<!DOCTYPE html>
<html>
<head>
    <title>Rekapan Setoran Tanpa Wali Kelas</title>
    <style>
...
<body>
    <h1>Rekapan Setoran Tanpa Wali Kelas</h1>
