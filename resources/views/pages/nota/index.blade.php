        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <h3 class="text-lg font-semibold mb-6">Cetak Nota Bulanan per Kelas</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        Pilih bulan dan kelas untuk membuat rekapitulasi setoran sampah dalam format PDF.
                    </p>
                    ...
                    <form action="{{ route('nota.cetak') }}" method="POST" target="_blank">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="month" id="bulan" name="bulan" value="{{ old('bulan', date('Y-m')) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                @error('bulan') <p class="mt-2 text-sm text-red-600">{{ $message }}</p> @enderror
                            </div>
                            <div>
